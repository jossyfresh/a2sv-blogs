            ...
            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-2">
              <div className="md:text-left text-center flex flex-col justify-center md:items-center space-y-5">
                ...
                <p className="mt-2 mb-3 text-base text-center	font-normal	text-text-header-2 max-w-[50ch]">
                  ...
                  structures and algorithms quite challenging. A2SV&apos;s
                  smooth learning process and dedicated team molded me to see
                  the peak of my abilities. Through A2SV&apos;s effective
                  education and continual support, I passed Google&apos;s
                  internship interviews and attended a summer internship at
                  Google in Amsterdam. However, the A2SV program and training is
                  beyond technical education and interview preparation. As an
                  A2SVian, I also learned the values of putting humanity first,
                  giving back to our community, and utilizing teamwork with my
                  colleagues, which I can now consider my big family. After
